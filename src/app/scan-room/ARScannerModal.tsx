    ...
    return (
        <div className="ar-modal">
            ...
            <div className="ar-modal__content" ref={containerRef}>
                ...
                {step < 4 ? (
                    ...
                    <div className="ar-sketchup-preview">
                        <GlassScene
                            ...
                            glassColor="rgba(200,230,255,0.3)"
                            glassOpacity={0.3}
                            hardwareColor="#e2e8f0"
                            hardwareMetalness={0.8}
                            interactive={true}
                            isOpen={false}
                ...
                {(step === 3 || step === 4) && (
                    <div className="ar-modal__ui ar-modal__ui--overlay">
                        <div className="ar-modal__header">
                            <button className="ar-btn-close" onClick={onClose} style={{ color: 'var(--text-primary)' }}>✕</button>
                            <div className="ar-modal__title" style={{ color: 'var(--text-primary)' }}>
                        ...
                        {step === 3 && (
                            <div className="ar-results-panel">
                                ...
                                <button className="ar-btn-confirm" onClick={() => setStep(4)}>
                                    Explorar Instalaciones (SketchUp)
                                </button>
                            </div>
                        )}
                        ...
                        {step === 4 && (
                            <div className="ar-explorer-panel">
                                    ...
                                    {TEMPLATES.map(t => (
                                        ...
                                        >
                                            <div className="ar-template-thumb">
                                                {/* Aquí se podría poner un icono o vista previa pequeña */}
                                ...
                                <div className="ar-explorer-actions">
                                    <button className="ar-btn-confirm" onClick={handleConfirm} style={{ marginTop: 0 }}>
            ...
            <style>{`
                ...
                /* Reuse or redefine styles from previous step */
